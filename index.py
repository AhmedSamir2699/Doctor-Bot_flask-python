...
@app.route('/mail')
def send_mail():
    msg = Message('Hello', sender='drbot.health@gmail.com', recipients=['ahmeddabbas19@gmail.com'])
...
def edit_profile():
    ...
    if request.method == 'POST':
        ...
        cur.execute(query_string, (form.firstName.data,form.lastName.data,form.age.data,form.password.data,form.email.data))
        con.commit()
